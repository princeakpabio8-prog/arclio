...
export const CALENDAR_EVENTS: CalendarEvent[] = [
  ...
  {
    id: "evt-002",
    title: "Acme Delivery Window",
    start: "10:00",
    end: "12:00",
    location: "Loading Dock — Bay 3",
    attendees: ["facilities@arclio.dev", "ops@arclio.dev"],
...
export const SECURITY_EVENTS: SecurityEvent[] = [
  ...
  {
    id: "sec-002",
    timestamp: todayAt("09:51"),
    type: "visitor_sign_in",
    location: "Reception",
    description: "Vendor representative signed in — escorted to dock",
    actor: "J. Smith (Acme Corp)",
  },
  {
    id: "sec-003",
    ...
    location: "Loading Dock — Bay 3",
    description: "Delivery vehicle arrived — Acme Corp",
    actor: "Acme Corp — plate AX-9921",
  ...
  },
  {
    ...
    type: "access_granted",
    location: "Loading Dock — Bay 3",
    description: "Loading dock opened for inbound delivery",
  ...
  },
  {
    ...
    location: "Loading Dock — Bay 3",
    description: "Motion detected — delivery offload in progress",
    cameraRef: "CAM-DOCK-03",
  },
  {
    id: "sec-006",
    ...
    location: "Loading Dock — Bay 3",
    description: "Delivery vehicle departed — dock secured",
    actor: "Acme Corp — plate AX-9921",
    cameraRef: "CAM-DOCK-03",
  },
  {
    id: "sec-007",
    timestamp: todayAt("11:53"),
    type: "visitor_sign_out",
    location: "Reception",
    description: "Vendor representative signed out — escort complete",
    actor: "J. Smith (Acme Corp)",
  },
  {
    id: "sec-008",
    ...
    description: "Access attempt — badge not authorised for this zone",
    actor: "unknown",
  },
];
